 ...
 * @subpackage Form
 */
class FileUploadImageAdmin extends FileUploadImage
{
    /**
    ...
    public function __construct(
        ...
        parent::__construct($label, $name, $uploadDirectory, $fileName, $label, $description, $size, $required, $notEdit, $renderTemplate, $imageTitleTemplate);
	...
	* Set no resize image.
	* 
	* @return \Engine\Crud\Form\Field\FileUploadImageAdmin
	*/
